...
export default function SectionHeader({
  ...
  return (
    <div className={`w-full mb-12 ${className}`}>
      {/* Eyebrow Row */}
      <div className="w-full flex flex-col sm:flex-row sm:items-center justify-between gap-1.5 pb-3 border-b-2 border-[#000000] font-mono text-[11px] sm:text-[12px] tracking-[0.08em] text-[#000000] font-bold uppercase">
